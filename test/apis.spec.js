...
describe("apis", function () {
    ...
    describe("hashKey", function () {
        ...
        it("is function:[unique id] for function", function () {
        ...
        it("calls the function $$hashKey as a method with correct this", function () {
            expect(hashKey({
                myKey: 42,
                $$hashKey: function () {
                    return this.myKey;
    ...
    describe("HashMap", function () {
        ...
        it("supports put and get of objects with hashKey smantics", function () {
            var map = new HashMap();
            var obj = {};
