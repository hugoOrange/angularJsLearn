...
describe("$http", function () {
    ...
    it("rejects promise when XHR result errors/abors", function () {
        var requestConfig = {
            method: 'GET',
            url: 'http://teropa.info'
        };
    ...
    it("parses response headers to transform function", function () {
        var response;
        $http({
            url: 'http://teropa.info',
    ...
    it("does not serialize blobs for requests", function () {
        // // chrome doesn't support BlobBuilder
    ...
    it("adds aditional params to URL", function () {
        $http({
    ...
    // difference: the below has request body
    it("supports shorthand mehtod for POST", function () {
    ...
    it("supports shorthand mehtod for PUT", function () {
    ...
    it("supports shorthand mehtod for PATCH", function () {
    ...
    it("allows intercepting responses", function () {
        ...
        var response;
        $http.get('http://teropa.info', {params: {}}).then(function (r) {
            response = r;
        });
        $rootScope.$apply();
