...
describe("injector", function () {
    ...
    it("loads the transitively required modules of a module", function () {
        ...
        module1.constant('aConstant', 42);
        module2.constant('anotherConstant', 43);
        module3.constant('aThirdConstant', 43);
    ...
    describe('annotate', function () {
        ...
        it("instantiates an none-annotated constructor function", function () {
            var module = angular.module('myModule', []);
            module.constant('a', 1);
            module.constant('b', 2);
            var injector = createInjector(['myModule']);
        ...
        it("users the prototype of the constructor when instantiating", function () {
            function BastType() {}
            BastType.prototype.getValue = _.constant(42);

            function Type() { this.v = this.getValue(); }
            Type.prototype = BastType.prototype;
    ...
    describe("$provider", function () {
        ...
        // provider -/-> get
        it("does not give access **providers** through get", function () {
            var module = angular.module('myModule', []);
    ...
    describe("high-level dependency injection", function () {
        ...
        // Config Blocks -- should be defined after dependencies defining
        ...
        it("configures all modules before running an run blocks", function () {
            var module1 = angular.module('myModule', []);
        ...
        it("runs a function module with array dependency as a config block", function () {
