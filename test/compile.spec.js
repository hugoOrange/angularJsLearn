describe("$compile", function () {
    ...
    it("allows createing directives", function () {
    ...
    it("compiles serveral attribute directives in an element", function () {
    ...
    // Compiling directives with multiple DOM
    ...
    describe("attributes", function () {
        ...
        it("sets props for boolean attributes", function () {
            registerAndCompile(
                'myDirective',
                '<input my-directive>',
                function (element, attrs) {
        ...
        it("denormalizes attribute name when explicitly given", function () {
            registerAndCompile(
                'myDirective',
                '<my-directive some-attribute></my-directive>',
                function (element, attrs) {
        ...
        it("use new attribute name after once given", function () {
            registerAndCompile(
                'myDirective',
                '<my-directive x-some-attribute="42"></my-directive>',
                function (element, attrs) {
        ...
        it("calls observer on next $digest after registration", function () {
            registerAndCompile(
                'myDirective',
                '<my-directive some-attribute="42"></my-attribute>',
        ...
        // Providing Class Directive As Attribute
        ...
        it("supports values for class directive attributes", function () {
            registerAndCompile(
                'myDirective',
                '<div class="my-directive: my attribute value"></my-directive>',
                function (element, attrs) {
                    expect(attrs.myDirective).toEqual('my attribute value');
                }
            );
        });
        it("terminates class direcitve attribute value at semicolon", function () {
            registerAndCompile(
                'myDirective',
    ...
    describe("linking", function () {
        ...
        it("links children when parent has no directive", function () {
            var givenElements = [];
            var injector = makeInjectorWithDirectives('myDirective', function () {
                return {
                    link: function (scope, element, attrs) {
        ...
        it("reverses prioroity for postlink functions", function () {
            var linkings = [];
            var injector = makeInjectorWithDirectives({
                firstDirective: function () {
                    return {
        ...
        it("allows aliasing expression attribute on ioslate scope", function () {
            var givenScope;
            var injector = makeInjectorWithDirectives("myDirective", function () {
                return {
                    scope: {
        ...
        it("warches isolated scope expression", function () {
            var givenScope;
            var injector = makeInjectorWithDirectives("myDirective", function () {
                return {
                    scope: {
        ...
        // Expression Binding
        it("allows binding an invokabled expression on the parent scope", function () {
            var givenScope;
            var injector = makeInjectorWithDirectives("myDirective", function () {
                return {
                    scope: {
    ...
    describe("controllers", function () {
        ...
        it("can return a semi-constructed controller", function () {
            ...
            expect(actualController.myAttr).toBe(42);
        });
        it("can return a semi-constructrd ctrl when using array injection", function () {
        ...
        it("does not find from sibling directive when requiring with ^^", function () {
            ...
            injector.invoke(function ($compile, $rootScope) {
                var el = $('<div my-directive div my-other-directive></div>');
                expect(function () {
                    $compile(el)($rootScope);
                }).toThrow();
            });
    ...
    describe("template", function () {
        ...
        // Disallowing two templates in one directive
        ...
        it("supports functions as template values", function () {
            ...
            injector.invoke(function ($compile) {
                ...
                $compile(el);
                expect(el.find("> .from-template").length).toBe(1);
                // Check that template function was called with element and atttrs
        ...
        // Added: templateUrl --- Asynchronous Templates
        describe("templateUrl", function () {
            ...
            it("links when template arrives if node link function was invoked", function () {
                var linkSpy = jasmine.createSpy();
                var injector = makeInjectorWithDirectives({
                    myDirective: function () {
                        return {
            ...
            // Linking Directives that Were Compiled Earlier (when use templateUrl)
            it("links when template arrives if node link function was invoked", function () {
                var linkSpy = jasmine.createSpy();
                var injector = makeInjectorWithDirectives({
                    myDirective: function () {
            ...
            // Ioslated Scope In The Asychronous Linking
            it("retains isolate scope directives from earlier", function () {
                ...
                var injector = makeInjectorWithDirectives({
                    ...
                    myOtherDirective: function () {
                        return {templateUrl: '/my_other_directive'};
                    }
                });
                injector.invoke(function ($compile, $rootScope) {
            ...
            // Translusion with Template URLs
            describe("with tranclusion", function () {
    ...
    describe("transclude", function () {
        ...
        it("makes contents available to directive link function", function () {
            ...
            injector.invoke(function ($compile, $rootScope) {
                ...
                expect(el.find("> [in-template] > [inside-transcluder]").length).toBe(1);
            });
        });
        ...
        it("stops watching when transcluding directives is destroyed", function () {
        ...
        it("allows passing another scope to transcludsion function", function () {
        ...
        it("makes content available to indirect child elements", function () {
            var injector = makeInjectorWithDirectives({
                myTranscluder: function () {
                    return {
                        transclude: true,
                ...
                inTemplate: function () {
                    return {
                        link: function (socpe, element, attrs, ctrl, transcludeFn) {
                            element.append(transcludeFn());
                        }
                    };
                }
    ...
    describe("clone attach function", function () {
        ...
        it("allows connecting transclued content", function () {
            var injector = makeInjectorWithDirectives({
                myTranscluder: function () {
                    return {
                        transclude: true,
        ...
        it("allows passing data to transclusion", function () {
            var injector = makeInjectorWithDirectives({
                    ...
                    return {
                        ...
                        link: function (scope, element, attrs, ctrl, transcludeFn) {
                            transcludeFn(function (transclNode, transclScope) {
                                transclScope.dataFromTrasncluder = 'Hello from transcluder';
                                element.find('[in-template]').append(transclNode);
                            });
                        }
                    };
                ...
                myOtherDirective: function () {
                    return {
                        link: function (scope, element) {
                            element.html(scope.dataFromTrasncluder);
                        }
                    };
                }
            });
